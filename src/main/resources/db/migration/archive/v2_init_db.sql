...
create table products (price integer, quantity integer, brand_id bigint, category_id bigint, composition_id bigint, id bigint not null, order_id bigint, article varchar(255) unique, color varchar(255), unit varchar(255), primary key (id));
