...
create table orders (total_price float(53), total_quantity integer, created timestamp(6), id bigint not null, updated timestamp(6), user_id bigint, address varchar(255), order_status varchar(255) check (order_status in ('CART','APPROVED','CANCELED','PAID','CLOSED')), primary key (id));
